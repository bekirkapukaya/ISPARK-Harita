...
class Ispark(models.Model):
    ...
    point = models.CharField(max_length=100, verbose_name='Enlem/Boylam')
    polygon = models.CharField(max_length=15000, verbose_name='Polygon Verisi')
    lat = models.CharField(max_length=50, verbose_name='Boylam')
    lon = models.CharField(max_length=50, verbose_name='Enlem')
